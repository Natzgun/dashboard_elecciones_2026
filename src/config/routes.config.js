...
export const PARTY_COLORS = {
  ...
  'JUNTOS POR EL PERÚ': '#16a34a',
  'RENOVACIÓN POPULAR': '#004B87',
  'PARTIDO DEL BUEN GOBIERNO': '#7c3aed',
  'PARTIDO CÍVICO OBRAS': '#0284c7',
  'PARTIDO PAÍS PARA TODOS': '#d97706',
  'AHORA NACIÓN - AN': '#dc2626',
  'PRIMERO LA GENTE': '#0d9488',
  'PARTIDO SICREO': '#6366f1',
  'FRENTE DE LA ESPERANZA 2021': '#f43f5e',
  'PODEMOS PERÚ': '#00B4D8',
  'COOPERACIÓN POPULAR': '#E41E20',
  'ALIANZA PARA EL PROGRESO': '#0066CC',
  'PARTIDO APRISTA PERUANO': '#b91c1c',
  'SOMOS PERÚ': '#E63946',
